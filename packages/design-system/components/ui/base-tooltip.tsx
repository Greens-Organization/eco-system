...
function TooltipPositioner({ ...props }: React.ComponentProps<typeof TooltipPrimitive.Positioner>) {
...
export { Tooltip, TooltipTrigger, TooltipContent, TooltipProvider, TooltipArrow, TooltipPositioner, tooltipVariants };
