...
## Why not use the original eco-system?

eco-system maintains all the quality and insights of eco-system, but adds the performance benefits of Bun. If you value development speed and a more modern experience, this is a natural evolution while maintaining the same solid foundation.
...
If you want to know more about the project that derived from this one, I recommend you visit it at [eco-system](https://www.next-forge.com/docs/faq)
