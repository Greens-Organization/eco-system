---
title: App
description: How the main application works in eco-system.
---
...
eco-system exports the main app from the `apps/app` directory. It is designed to be run on a subdomain of your choice, and is used to run the main user-facing application.
...
- **Database**: The app is connected to the [Database](/packages/db) and can fetch data in React Server Components.
