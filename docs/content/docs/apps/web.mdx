---
title: Web
description: How the website application works in eco-system.
---
...
eco-system comes with a default website application, which is located in the `apps/web` folder.
