...
description: How we've configured uptime monitoring in eco-system.
---
...
next-forge provides a `Status` component from `@pack/observability` that displays the current status of the application. You can see an example of this in the website footer.
